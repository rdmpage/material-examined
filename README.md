...
UF:UF10868 needs extend 30 to find, matched to occurrence/899580307 (Raoulserenea oxyrhyncha), genBank GQ260977 Raoulserenea komaii “Reef-associated crustacean fauna: biodiversity estimates using
            semi-quantitative sampling and DNA barcoding” 
...
MNHN_2008-998  GBIF fails to map http://gbif.org/occurrence/583438267 to anything, but genus is present. Also a BOLD sample MBFA840-07 (Moorea) also in GenBank JQ431469 georeferenced (not in GBIF),
GenBank vouch is MBIO1419.4, can link via BOLD
...
MPEG 23603 -> holotype http://dx.doi.org/10.1643/CI-12-087 (BioOne, has lats and longs)
- GBIF verbatim data has big numbers which are probably lats and longs…
...
AMS R157911 -> DQ675197, twice in GBIF 482599951 774857161 R.157911 and R.157911.001
- GBIF “Scincidae Gray, 1825”, verbatim “ Caledoniscincus sp.”, GenBank Caledoniscincus auratus
...
### To search for types in GBIF 


http://api.gbif.org/v1/occurrence/search?scientificName=Reptilia&typeStatus=HOLOTYPE

## Type examples

### USNM 534311

(bee, fuzzy match but to sure why as got name correct)
...
verbatim has scientific name Dicaeum haematostictum whiteheadi Hachisuka, 1926,
