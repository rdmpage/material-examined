...
Experiments in “resolving” specimen codes to identifiers, with a view to linking specimens across GBIF, GenBank, BOLD, and BioStor. For background see [Some design notes on modelling links between specimens and other kinds of data](https://iphylo.blogspot.co.uk/2014/08/some-design-notes-on-modelling-links.html), [Linking GBIF and Genbank](https://iphylo.blogspot.co.uk/2012/02/linking-gbif-and-genbank.html) and [GBIF specimens in BioStor: who are the top ten museums with citable specimens?](https://iphylo.blogspot.co.uk/2012/02/gbif-specimens-in-biostor-who-are-top.html). See also:
...
Related projects include [sharifX/pid-specimen-genbank](https://github.com/sharifX/pid-specimen-genbank) and [AgentschapPlantentuinMeise/linkedTaxonomy](https://github.com/AgentschapPlantentuinMeise/linkedTaxonomy).
